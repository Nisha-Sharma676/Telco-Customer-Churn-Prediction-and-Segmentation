...
| Final Model | RF (300 trees, depth 10) | 0.78 | 0.60 | 0.74 | 0.66 |
...
So, Model is stable and generalizes well.

---

## 📉 ROC-AUC Analysis

ROC-AUC curve evaluates model’s ability to distinguish between classes.
...
- **Precision (Class 1):** Of predicted churn customers, how many actually churned  
- **Recall (Class 1):** Of actual churn customers, how many were correctly identified  

In this project, **Recall is more important** because missing a churn customer leads to business loss.
...
Insight: Low tenure + high charges = high churn risk
